...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogFooter } from '@quak/ui/dialog';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@quak/ui/select';
import { ElementSelectorDto } from '@quak/circuit-core';
