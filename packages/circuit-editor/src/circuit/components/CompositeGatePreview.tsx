...
import { CompositeQuantumGateDto, isCompositeGate, formatRotationAngle } from '@quak/circuit-core';
import { getOperationDefinition } from '#operations.ts';
import { buildCompositePreview, PreviewOperation } from '../util/compositePreview.ts';
