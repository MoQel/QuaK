...
import { CompositeQuantumGateDto, isCompositeGate, isSubcircuit, SubcircuitOperationDto } from '@quak/circuit-core';
...
import { CELL_WIDTH, LOOP_GATE_SCALE, QUBIT_HEIGHT, getSelectorVisualY } from '../util/layout.ts';
