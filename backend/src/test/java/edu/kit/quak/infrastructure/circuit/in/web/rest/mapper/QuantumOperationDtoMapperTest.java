...
class QuantumOperationDtoMapperTest {
    ...
    void toDomain() {
        ...
        assertEquals(gateDto.getId(), gate.getId()); // Provided ids are kept (stable identity across saves)
        ...
        assertEquals(measurementDto.getId(), measurement.getId());
    ...
    @Test
    void toDomain_withoutId_generatesOne() {
        // Arrange
        ElementSelectorDto target = new ElementSelectorDto("reg_id", 0);
        ElementaryQuantumGateDto gateDto = new ElementaryQuantumGateDto(
            null,
        ...
        // Assert: missing ids fall back to a freshly generated one
