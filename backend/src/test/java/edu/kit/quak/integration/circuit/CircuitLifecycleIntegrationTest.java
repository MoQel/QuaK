...
class CircuitLifecycleIntegrationTest {
    ...
    void testFullCircuitLifecycle() throws Exception {
        ...
        mockMvc.perform(post("/api/circuit/" + circuitId + "/register/" + registerId)
        ...
        MvcResult addHGateResult = mockMvc.perform(post("/api/circuit/" + circuitId + "/operation")
                        .with(authenticatedUser())
                        .with(csrf())
        ...
        MvcResult addCxGateResult = mockMvc.perform(post("/api/circuit/" + circuitId + "/operation")
                        .with(authenticatedUser())
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(cxGateJson))
        ...
        mockMvc.perform(patch("/api/circuit/" + circuitId + "/operation")
                        .with(authenticatedUser())
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(moveJson))
