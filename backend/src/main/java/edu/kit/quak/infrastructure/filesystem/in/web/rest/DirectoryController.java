...
import edu.kit.quak.infrastructure.filesystem.in.web.mapper.DirectoryMapper;
...
public class DirectoryController {
    ...
    public DirectoryController(DirectoryServicePort service, DirectoryMapper mapper) {
