...
public class CircuitRestAdapter {
    ...
    public CircuitRestAdapter(CircuitServicePort service,
    ...
    public CircuitResponse removeQubit(@PathVariable String circuitId,
                                       @PathVariable String registerId,
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public CircuitResponse addQuantumOperation(@PathVariable String circuitId,
    ...
    public CircuitResponse moveQuantumOperation(@PathVariable String circuitId,
        ...
        QuantumCircuit circuit = service.moveQuantumOperation(circuitId, request.quantumOperationId(), request.layerIdx(),
                targetQubits, controlQubits);
        return mapper.toResponse(circuit);
    }

    @DeleteMapping("/{circuitId}/operation/{operationId}")
    public CircuitResponse removeQuantumOperation(@PathVariable String circuitId,
