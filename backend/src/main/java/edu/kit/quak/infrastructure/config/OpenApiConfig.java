...
public class OpenApiConfig {
    ...
    public OpenAPI quakOpenAPI() {
        return new OpenAPI()
                ...
                .servers(List
                        .of(new Server().url("http://localhost:" + serverPort).description("Local Development Server")))
                ...
                .tags(
                        List.of(
                                ...
                                new Tag().name("Operation Definitions")
                                        .description("Definitions of quantum operations"),
