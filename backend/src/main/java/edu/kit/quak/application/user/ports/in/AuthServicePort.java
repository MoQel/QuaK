...
public interface AuthServicePort {
     ...
     * 
     * @param authenticatedUser Optional authenticated user, empty if not
     *                          authenticated
     * @param userInfo          Optional user info map (email, name, picture) from
     *                          the identity provider
     * @return Map containing authentication status and user info if authenticated
     */
    Map<String, Object> getAuthenticationStatus(Optional<AuthenticatedUser> authenticatedUser,
     ...
     * @param userInfo          User info map (email, name, picture, sub) from the
     *                          identity provider
     * @return Map containing user information
     * @throws IllegalStateException if user is not authenticated
     */
    Map<String, Object> getAuthenticatedUserInfo(AuthenticatedUser authenticatedUser,
