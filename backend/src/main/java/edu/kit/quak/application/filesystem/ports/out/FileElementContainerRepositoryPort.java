 ...
 * declare the ID
 * prefix it manages. The prefix is used to route persistence operations to the
 * correct repository.
 *
...
public interface FileElementContainerRepositoryPort<T extends FileElementContainer<?>> extends FileElementRepositoryPort {
    ...
    /**
     * Finds the owner ID of the root project containing the given element. This
     * method traverses
     * the hierarchy upward to find the root project in a single efficient database
     * query.
     *
    ...
    /**
     * Finds the ID of the root project containing the given element. This method
     * traverses the
     * hierarchy upward to find the root project in a single efficient database
     * query.
     *
     * @param elementId The ID of any file element (file, directory, or project)
     * @return The project ID, if found
     */
    Optional<String> findProjectIdByElementId(String elementId);
}
