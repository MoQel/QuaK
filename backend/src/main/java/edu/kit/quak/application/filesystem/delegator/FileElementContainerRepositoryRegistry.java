 ...
 * <p>
 * Maps repositories to their unique ID prefixes to enable dynamic lookup.
 * Ensures prefix uniqueness during application startup to guarantee unambiguous
 * routing for polymorphic domain objects.
 * </p>
 */
@Component
