...
/**
 * Thrown when a user cannot be found in the database. This is a domain exception that should be
 * mapped to HTTP 401 Unauthorized by the infrastructure layer.
 */
