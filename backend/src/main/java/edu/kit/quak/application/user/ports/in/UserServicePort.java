...
/**
 * Input port defining user-related use cases. Uses only domain concepts, no framework dependencies.
 */
public interface UserServicePort {
    ...
    /**
     * Efficiently retrieves only the authenticated user's UUID without loading the full entity. Use
