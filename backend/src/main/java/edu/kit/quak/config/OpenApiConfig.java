...
/**
 * OpenAPI / Swagger configuration for the QuaK API documentation.
 * This class configures the API metadata displayed in Swagger UI.
 * 
 * In development mode (dev profile), use HTTP Basic Auth with:
 * - Username: admin
 * - Password: admin
 */
@Configuration
