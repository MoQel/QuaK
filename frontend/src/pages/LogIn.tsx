            ...
            <div className="w-full max-w-md">
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
                    <div className="text-center mb-8">
                        <h1 className="text-5xl font-bold mb-2 bg-gradient-to-r from-white to-white bg-clip-text text-transparent">
                            QuaK
                        </h1>
                    ...
                    <div className="space-y-6">
                        <div className="text-center">
                            ...
                            <p className="text-white/70">Sign in to access your quantum projects</p>
                        </div>
                        ...
                        <div className="text-center text-white/60 text-sm">
                            <p>Secure login powered by Google & GitHub OAuth 2.0</p>
                        </div>
                    </div>
                </div>
